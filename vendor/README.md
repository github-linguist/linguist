...
This doesn't apply to the following languages on GitHub; these are powered by [Tree-sitter](https://github.com/tree-sitter) grammars:
...
The grammars associated with the languages below are still included with Linguist as they may be used by other languages or users of Linguist.
