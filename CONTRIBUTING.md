...
Note that Linguist uses [PCRE](https://www.pcre.org/) regular expressions, while TextMate uses [Oniguruma](https://github.com/kkos/oniguruma) library. Although they are mostly compatible there might be some differences in syntax and semantics between the two. 
You can test grammars against the GitHub’s syntax highlighter using [Lightshow](https://github-lightshow.herokuapp.com).
