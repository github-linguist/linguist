...
Before you can start contributing to Linguist, you'll need to set up your environment first. Clone the repo and run [Bundler](http://gembundler.com/) to install its dependencies.
