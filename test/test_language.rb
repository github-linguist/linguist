...
class TestLanguage < Minitest::Test
  ...
  def test_find_by_extension
    ...
    assert_equal [Language['Limbo'], Language['M'], Language['MATLAB'], Language['MUF'], Language['Mathematica'], Language['Mercury'], Language['Objective-C'], Language['Octave']], Language.find_by_extension('foo.m')
