...
class TestGenerated < Minitest::Test
  ...
  def test_check_generated
    ...
    generated_sample_without_loading_data("vendor/github.com/golang/snappy/snappy.go")
    generated_sample_without_loading_data("vendors/manifest")
    generated_sample_without_loading_data("cmd/app/vendor/github.com/kr/s3/sign.go")
    generated_sample_without_loading_data("third-party/manifest")
    generated_sample_without_loading_data("thirdparty/manifest")
    generated_sample_without_loading_data("3rd_party/manifest")
    generated_sample_without_loading_data("external/manifest")
    generated_sample_without_loading_data("extern/manifest")
