...
class TestMD5 < Minitest::Test
  ...
  def test_hexdigest_integer
    ...
    assert_equal "eb70b9dc51f70acc91b4d984ef81570e", MD5.hexdigest(3)
  ...
  def test_hexdigest_array
    ...
    assert_equal "2f82cdc166616208077ff1dd0a8faeff", MD5.hexdigest([1, 2, 3, 4])
    assert_equal "7c6285c53bb82c9b58c0c28329f8d8f4", MD5.hexdigest([1, 2, 3, [4]])
  end
  ...
  def test_hexdigest_hash
    ...
    assert_equal "edfd4aed358b4d346b7eb7adf0fd21d1", MD5.hexdigest({:c => 3})
