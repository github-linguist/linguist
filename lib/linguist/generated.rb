module Linguist
  class Generated
    ...
    # Internal: Does this file have a header which indicates that it is
    # generated?
    #
    # This allows people to use a header to indicate generated code in
    # arbitrary languages.
    #
    # Return true or false
    def has_generated_header?
      # We use the first two lines in case the first line cannot contain a
      # comment (shebang lines or similar).
      return lines.take(2).any? { |line| line.include? "Code generated by" }
    end
  end
end
