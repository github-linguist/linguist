module Linguist
  class Generated
    ...
    RAILS_ERROR_PAGES = %w[400 404 406-unsupported-browser 422 500]

    # Internal: Is this an error page generated by `rails new`?
    #
    # Rails writes 400, 404, 406-unsupported-browser, 422 and 500 pages into
    # public/, each containing a comment naming its own path:
    #   <!-- This file lives in public/404.html -->
    #
    # Returns true or false
    def generated_rails_error_page?
      match = name.match(%r{(?:\A|/)public/(?<page>#{Regexp.union(RAILS_ERROR_PAGES)})\.html\z})
      return false unless match

      marker = "<!-- This file lives in public/#{match[:page]}.html -->"
      lines.any? { |line| line.include?(marker) }
    end
