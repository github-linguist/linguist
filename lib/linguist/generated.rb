module Linguist
  class Generated
    ...
    def generated_go?
      ...
      # old check for the transitional period (remove it later)
      return true if lines[0].include?("Code generated by")

      # https://golang.org/s/generatedcode
      return lines.find {|line| line =~ /^\/\/ Code generated .* DO NOT EDIT\.$/ }
    end
