module Linguist
  class Generated
    ...
    # Internal: Is the blob a cassette generated by VCR?
    #
    # YAML cassettes generated by VCR 2 have a 'recorded_with'
    # entry with VCR current version.
    #
    # Returns true or false.
    def vcr_cassette?
      if extname == '.yml'
        lines.any? { |line| line =~ /recorded_with: VCR/ }
      else
        false
      end
    end
